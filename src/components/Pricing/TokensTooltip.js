      ...
      <Panel padding className={styles.tooltip}>
        <p className={styles.text}>
          <b>
            {tr(
              "pricing.discount",
              "Here’s how to claim the SAN holding discount:"
            )}
          </b>
        </p>
        <ul className={styles.list}>
          ...
          <li className={styles.item}>
            ...
            {tr(
              "pricing.discount.step.login.right",
          ...
          <li className={styles.item}>
            -{" "}
            {tr(
              "pricing.discount.step.settings.left",
            ...
            {tr(
              "pricing.discount.step.settings.right",
          ...
          <li className={styles.item}>
            -{" "}
            {tr(
              "pricing.discount.step.system",
              "Our system checks your Sanbase account for 1000+ SAN during the checkout, and automatically applies a 20% discount"
            )}{" "}
          </li>
        </ul>
        <p className={styles.text}>
          ...
          {tr(
            "pricing.discount.note.text",
            "To claim the 20% discount, you just need to hold/HODL enough SAN. The tokens still belong to you - our system simply checks if you have them in your wallet"
          )}
        </p>
      </Panel>
    </ContextMenu>

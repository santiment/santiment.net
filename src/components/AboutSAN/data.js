export const data = [
  {
    ...
    desc:
      "SAN is the only way to access exclusive and premium feeds via auctions and subscriptions. SAN will be required for feeds that decrease in value according to how many people have access"
  },
  {
    title: "Stake",
    ...
    desc:
      "SAN can be staked to access some Santiment services for free. Institutional players can stake larger amounts and give their userbase access to Santiment services and revenue sharing"
  },
  {
    title: "Reward",
    ...
    desc:
      "Santiment gives SAN to those who contribute data and information to the network. A central feature of crowdsourced datafeeds"
  }
];

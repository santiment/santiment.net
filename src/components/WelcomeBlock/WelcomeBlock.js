...
const WelcomeBlock = () => (
  <section className={styles.wrapper}>
    <img
      src={Dash}
      className={cx(styles.dash, styles.coin, styles.coinLeft)}
      alt="dash"
    />
    <img
      src={Litecoin}
      className={cx(styles.litecoin, styles.coin, styles.coinLeft)}
      alt="litecoin"
    />
    <img
      src={Bitcoin}
      className={cx(styles.bitcoin, styles.coin, styles.coinLeft)}
      alt="bitcoin"
    />
    <img
      src={Ripple}
      className={cx(styles.ripple, styles.coin, styles.coinRight)}
      alt="ripple"
    />
    <img
      src={Eth}
      className={cx(styles.eth, styles.coin, styles.coinRight)}
      alt="eth"
    />
    <img
      src={Zcash}
      className={cx(styles.zcash, styles.coin, styles.coinRight)}
      alt="zcash"
    />

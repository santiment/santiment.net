...
export const data = [
	{
		...
		description: "See on-chain, social and development information visualized against price for 2000+ crypto assets, and set up alerts for major network anomalies.",
		img: studio
	},
	{
		title: 'Alerts',
